...
def main():
    ...
    try:
        ...
        colunas = ['Memory span', 'Acuracia Go', 'Acuracia nogo', 'Capacidade de rastreamento', 'Flexibilidade cognitiva (B-A)']
        ...
        if path_csv.is_file():
            ...
            print("  Skipping data processing (no CSV found). Using existing .pkl if present.")
    ...
    try:
        ...
        if pkl_path:
            ...
            print("  Permutation test completed. See figures/permutation_test_proof.png")
        else:
